...
EMBEDDING_MODEL = os.getenv("EMBEDDING_MODEL", "text-embedding-3-large")  # OpenRouter model
...
EMBEDDING_DIMENSION = int(os.getenv("EMBEDDING_DIMENSION", 3072))  # text-embedding-3-large dimension